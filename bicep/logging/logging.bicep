...
@description('Daily cap in GB for the ingest into the Workspace. - DEFAULT VALUE: 100')
param parLogAnalyticsWorkspaceDailyCapInGB string = '100'
...
resource resLogAnalyticsWorkspace 'Microsoft.OperationalInsights/workspaces@2021-06-01' = {
  ...
  properties: {
    ...
    workspaceCapping: {
      dailyQuotaGb: json(parLogAnalyticsWorkspaceDailyCapInGB)
    }
